"""
Reads in communication interaction events and saves to dicts
...
def add_interaction_old(interaction, edge_dict, interaction_dict):
	"""
	Given a named tuple of a data phone record with unix_time added
...
def add_interaction(interaction, edge_dict, interaction_dict):
	...
	Given a named tuple of a data phone record with unix_time added
		adds record to interaction and edge dicts
	"""
	# to ignore anything other than call or text
	if interaction.event_type > 1:
		return
